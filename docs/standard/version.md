...
当前文档采用 Header `array(7)`、Header Extension 注册表以及 Type ID `0`–`5`，其中 Type ID `5` 为 Shape。此前草案中 Header `array(6)`、顶级 Device 以及 Type ID `5` 为 Media 的 version 10 文件视为未发布草案，不属于本规范的兼容范围。
